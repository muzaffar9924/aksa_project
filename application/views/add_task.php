			...
			<div class="col-lg-9">
				<div class="row ">
					...
					<div class="card recent-sales overflow-auto">
						...
						<form class="row g-3 needs-validation p-5 pt-0 justify-content-center" novalidate action="<?= base_url('task/add_task'); ?>" method="post">
							...
							<div class="col-md-10 position-relative" id="date">
								...
								<input name="allocation_date" type="date" value="<?php date_default_timezone_set('Asia/Kolkata');
							...
							<div class="col-md-5 position-relative " id="start_date">
								...
								<input name="start_date" id="start_date1" value="<?php date_default_timezone_set('Asia/Kolkata');
							...
							<div class="col-md-5 position-relative " id="start_time">
								...
								<input type="time" name="start_time" id="start_time1" value="<?php date_default_timezone_set('Asia/Kolkata'); ?>" class="form-control" required />
							</div>
							...
							<div class="col-md-5 position-relative " id="end_date">
								...
								<input name="end_date" id="end_date1" type="date" value="<?php date_default_timezone_set('Asia/Kolkata');
